const config = {
  ...
  */
  ...
  correctSearchQueries: [
    ...
    "hoelang zijn we al samen?",
    "Hoelang zijn we samen?",
    "hoelang zijn we samen?",
    "Hoe lang zijn we al samen?",
    "hoe lang zijn we al samen?",
    "Hoe lang zijn we samen?",
    "hoe lang zijn we samen?",
    "Hoelangsijnwealsamen",
    "hoelangsijnwealsamen",
    "Hoelangsijnwesamen",
    "hoelangsijnwesamen",
    "Hoe lang zijn w al samen",
    "hoe lang zijn w al samen",
    "hoelang zyn we al samen",
    "hoelng zijn we al samen",
    "hoelng zyn we samen",
    "hoelng zijn w samen",
    "hoelang zijn weal samen",
    "hoelangzijnwealsamen",
    "Hoelang zijn we al samen",
    "hoelang zijn we al samen",
  ],
};
